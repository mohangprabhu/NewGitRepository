package com.mycompany.contentproviderapplication;
...
public class BirthProvider extends ContentProvider {
    ...
    static final String PROVIDER_NAME = "com.mycompany.provider.Birthday";
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        // This is Implemented to handle requests to update one or more rows.
        int count = 0;
        switch (uriMatcher.match(uri)){
            case FRIENDS:
    ...
    public String getType(Uri uri) {
        // This is implemented to handle requests for the MIME type of the data
        // at the given URI.
        switch (uriMatcher.match(uri)){
